...
We will enable Issues and Discussions to facilitate project management and communication.

- Go to the repository settings
- Scroll down to the General section
- Find the Features checkbox list
- Enable Issues and Discussions
...
- Click the link to view the deployed website
- Add the URL to the 'About' section
...
::: {.aside}
Note: Build and deploy the project website to see the changes.
:::
