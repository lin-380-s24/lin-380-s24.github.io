...
![](images/hello-hand.jpg)

# {background-image="images/lin-380-flyer.png" background-size="80%"}
...
![](images/fig-eda-masc-vsm-word2vec-manner-motion-compare-1.png){.absolute top=50 width="50%"}

![](images/fig-eda-masc-verb-part-network-1.png){.absolute top=50 right=0 width="50%"}

![](images/fig-ida-multi-sex-plot-2.png){.absolute bottom=20 right=100 height="40%"}

![](images/language-change.png){.absolute bottom=20 left=50 width="50%"}
...
::: {.column width="40%"}
![](images/hypothes.is.png){.absolute top=250 right=0 width="35%"}
:::
::::
...
We will use GitHub to share and collaborate on course materials.

:::: {.columns}
::: {.column width="60%"}
1. Create a [GitHub](https://github.com/) account
2. Join the course organization \
[lin-380-s24](https://github.com/lin-380-s24)
:::

::: {.column width="40%"}
![](../guides/get-up-with-git/github.png){.absolute top=200 right=0 width="45%"}
:::
::::

::: {.aside}
Detailed instructions found in the [Getting up to speed with Git and GitHub](https://lin-380-s24.github.io/guides/get-up-with-git.html) guide.
:::
