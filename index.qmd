...
2. <a id="statement">Research statement</a>
   ...
   - Continue to refine your interest in a more specific area gathering more information from the literature and identifying perceived gaps and potential areas of contribution.
   - Refine your interest into a specific research question or hypothesis.
   - Outline the objectives of your research and the expected outcomes.
...
4. <a id="analysis">Data analysis: selection, engineering, and modeling</a>
   ...
   - Describe the analytical techniques you plan to use to answer your research question.
   - Discuss how you will engineer features from the data and the rationale behind your methodological choices.
